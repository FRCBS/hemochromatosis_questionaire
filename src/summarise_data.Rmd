...
colnames(items) <- c(
  "After receiving genetic information about hemocromatosis, how are you planning to continue to donate?"
)
...
p <- p + xlab("When you gave your consent for biobank, did you understand it could lead to receiving information relevant to your health?")
p
...
p <- p + xlab("Would you like to receive similar information in the future, should it appear?")
p
...
p <- p + xlab("Did you get a clinical diagnosis for hemochromatosis (ICD10: E83.1)?")
p
...
p <- p + xlab("I have discussed about my predisposition to hemochromatosis with my close relatives.")
p
