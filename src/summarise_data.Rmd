...
labsum <- data %>%
  ...
  mutate(
    ...
    Fe_HUScut = case_when(
      ...
      (Kys20bFerrit >= 15 & Kys20bFerrit <=50) & Kys2Gender == "Female"   ~ "normal",
      (Kys20bFerrit >= 20 & Kys20bFerrit <=50) & Kys2Gender == "Male"   ~ "normal",
      TRUE ~ NA),
...
xpq22 <- ggplot(data)
xpq22 <- xpq22 + geom_bar(aes(x=Kys22Diagnosis))
xpq22 <- xpq22 + xlab("Did you get a clinical diagnosis\nfor hemochromatosis (ICD10: E83.1)?") + ylab("Count")
xpq22 <- xpq22 + theme(plot.margin = unit(c(1,2,1,2),"cm"))
xpq22 <- xpq22 + theme_bw()
xpq22


patch <-  (xpq09 |  xpq12) /  (xpq24 | xpq22) 
