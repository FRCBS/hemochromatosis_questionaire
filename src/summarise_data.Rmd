...
#p <- p + scale_x_log10() + geom_vline(aes(xintercept = 15, col = "red"))
...
#data <- data %>% mutate(GENDER = factor(Kys2Gender))
#levels(data$GENDER) <- c("Male", "Female")
#Voikohan näiden avulla saada johdettua sukupuolittain eri viiterajat..?
