...
#Uusia kohtia kysymys 20, 1) onko testi tehty 2)testin tulos
...
data %>% 
  ...
  filter(Kys20bFerrit >= 50 ) %>%  # pitäskö olla 50 > vai 50 >=
...
```{r}
#Tämä ei nyt ole se mitä haetaan, yritys oli saada diagnoosin saaneet ja heidän Ferrit & trfesat kuvaan, johon vielä voisi merkitä trfesat yli 30 ja ferrit yli 50. Taulukkoakin kokeilin, mutta siinäkin sitten vain mediaanit ym.
...
```{r}
ggcorrplot(corr, p.mat = p.mat, hc.order = TRUE, lab = TRUE,
